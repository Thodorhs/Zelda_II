...
#define MAX_PIXEL_WIDTH MUL_TILE_WIDTH(MAPWIDTH)
#define MAX_PIXEL_HEIGHT MUL_TILE_HEIGHT(MAPHEIGHT)
#define GRID_ELEMENT_WIDTH 8
#define GRID_ELEMENT_HEIGHT 8
#if 32 % GRID_ELEMENT_WIDTH != 0
#error "TILE_WIDTH % GRID_ELEMENT_WIDTH must be zero!"
#endif
#if 32 % GRID_ELEMENT_HEIGHT != 0
#error "TILE_HEIGHT % GRID_ELEMENT_HEIGHT must be zero!"
#endif
#define GRID_BLOCK_COLUMNS (32 / GRID_ELEMENT_WIDTH)
#define GRID_BLOCK_ROWS (32 / GRID_ELEMENT_HEIGHT)
